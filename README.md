...
The frontend workspace is now explicitly split so the mobile and web clients can evolve independently while both intended to use the same backend API service in `backend/`.
