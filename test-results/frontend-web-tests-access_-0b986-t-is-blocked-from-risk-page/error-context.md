...
- Name: frontend\web\tests\access_restriction.spec.js >> Guest Access Restriction >> Guest is blocked from risk page
- Location: frontend\web\tests\access_restriction.spec.js:12:3
...
Expected substring: "Guest mode: Personalized risk scoring is only available to registered users"
Timeout: 5000ms
