...
- Name: frontend\web\tests\access_restriction.spec.js >> Guest Access Restriction >> Guest is blocked from forecast
- Location: frontend\web\tests\access_restriction.spec.js:24:3
...
Expected substring: "Guest mode: Forecasting is only available to registered users"
Timeout: 5000ms
