...
- Name: frontend\web\tests\access_restriction.spec.js >> Guest Access Restriction >> Guest is blocked from smart alerts
- Location: frontend\web\tests\access_restriction.spec.js:16:3
...
Expected substring: "Guest mode: Prioritized alerts are only available to registered users"
Timeout: 5000ms
