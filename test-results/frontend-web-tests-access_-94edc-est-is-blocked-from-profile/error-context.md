...
- Name: frontend\web\tests\access_restriction.spec.js >> Guest Access Restriction >> Guest is blocked from profile
- Location: frontend\web\tests\access_restriction.spec.js:20:3
...
Expected substring: "Guest mode: Profile management is only available to registered users"
Timeout: 5000ms
