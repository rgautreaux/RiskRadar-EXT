...
| 1 | S1-01 | Define web extension architecture and backend API integration flow | High | Not Started | Rebecca | Week of 2026-03-17 | 2026-03-10 | S1-00 | TBD | Include alerts, summaries, and users endpoint contract details (method, params, response shape, fallback behavior). |
